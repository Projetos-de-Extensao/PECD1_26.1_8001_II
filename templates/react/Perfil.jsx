...
function Perfil() {
  ...
  return (
    <>
      {/* Nav próprio do Perfil — tem hamburger e links diferentes do NavBar.jsx */}
      <nav className="navegacao" role="navigation" aria-label="Menu principal">
        <div className="nav-container">
          ...
          <ul className={`menu-principal${menuAberto ? ' aberto' : ''}`}>
            <li>
              <a href="/dashboard" className="menu-link" onClick={() => setMenuAberto(false)}>
                Dashboard
              </a>
            </li>
            <li>
              <a href="/solicitacoes" className="menu-link" onClick={() => setMenuAberto(false)}>
                Solicitações
              </a>
            </li>
            <li className="menu-com-submenu">
              <button
                ...
                aria-expanded={submenuPerfilAberto}
                aria-haspopup="true"
                onClick={e => { e.stopPropagation(); setSubmenuPerfilAberto(prev => !prev); }}
              >
                Perfil <span aria-hidden="true">▼</span>
              </button>
              <ul className={`submenu-perfil${submenuPerfilAberto ? ' aberto' : ''}`} role="menu">
                <li role="none">
                  <a href="/perfil" role="menuitem" onClick={() => setSubmenuPerfilAberto(false)}>
                    Dados
                  </a>
                </li>
