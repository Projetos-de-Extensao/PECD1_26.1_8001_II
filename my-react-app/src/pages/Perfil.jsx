...
useEffect(() => {
    async function carregarDadosUsuario() {
      // Molde do usuário zerado
      const USUARIO_ZERADO = {
        iniciais: '-',
      ...
      try {
        ...
        setUsuario(dados || USUARIO_ZERADO);

      } catch (erro) {
        console.error('API sem dados, mostrando perfil zerado.');
        // Se a API não responder, joga o usuário zerado na tela
  ...
  if (carregandoPerfil) return <p style={{textAlign: 'center', padding: '3rem'}}>Carregando...</p>;
  
  // APAGUE O BLOCO DE ERRO AQUI TAMBÉM ("if (erroPerfil || !usuario)")
  // ==========================================
